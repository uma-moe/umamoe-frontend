  ...
  private getSteps(): IStepOption[] {
    return [
      ...
      },
      {
        ...
        content: 'Carat Planner projects your resources through future banners, combining saved balances, recurring income, scheduled rewards, free pulls, tickets, and Crystal Shards.',
        placement: { xPosition: 'after', yPosition: 'below' },
        isAsync: true,
      ...
      },
      {
        ...
        content: 'The summary immediately shows whether the full plan is funded, plus projected Carats, tickets, Crystal Shards, and total planned pulls after every target.',
        placement: { xPosition: 'after', yPosition: 'above' },
        isAsync: true,
        asyncStepTimeout: 5000,
        isOptional: true,
      ...
      },
      {
        ...
        content: 'Targets run in date order. Set pulls, timing, ticket use, Uncap Crystals, featured pickup goals, and desired copies. Open a target to inspect funding and the published probability of meeting those goals.',
        placement: { xPosition: 'after', yPosition: 'above' },
        isAsync: true,
        asyncStepTimeout: 5000,
        isOptional: true,
