...
export interface PlannerGlobalRewardComparison {
  ...
  speculative_method?: 'mean_last_6_complete_calendar_months_global_only_gifts' | 'mean_last_6_complete_calendar_months' | 'mean_last_12_complete_calendar_months' | 'median_last_6_complete_calendar_months' | string;
